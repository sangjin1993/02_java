...
/**
 * 서점에서 할 수 있는 여러 기능들
 * 책찾기, 책수정, 신간추가, 책폐기 등의 기능을 테스트하는 클래스
...
public class BookStoreTest {
	...
	public static void main(String[] args) {
		...
		Book littlerPrince = new Book(2, "9791188345069", "어린왕자", "생텍쥐페리", "더스토리", 150, 8820, 5);
		...
		//2. 서점에 도착한 신간 입고
		System.out.println("2. ==== 신간 생성 =====");
		kyobo.add(vegetarian);
		kyobo.add(littlerPrince);
		kyobo.add(noDaap);
		kyobo.add(dduk);
		kyobo.add(ax);
